...
const IndividualNotification: React.FC<any> = ({ notification, token }) => {
  const dispatch = useDispatch();

  useEffect(()=>{

    if(notification && notification.requestType==="friend_request" && notification.status==="accepted"){
  ...
  const handelAcceptFollowRequest = () => {
    dispatch(notificationFollowRequestAcceptAction(notification.requestor._id,token));
  };
  ...
  return (
    <div className="notification_body">
      ...
      <div>
        ...
        {acceptLoading === false && accepted === false &&  canceledRequest === false && cancel === false &&
          <Button onClick={handelAcceptFollowRequest} variant="contained">Accept</Button>
        }

        {acceptLoading===false && accepted===true &&
          <Button onClick={handelAcceptFollowRequest} disabled variant="contained">Accepted</Button>
        ...
        {canceledRequest === false && cancel === false &&  acceptLoading === false && accepted === false && (
          <>
            <Button
